...
declare module '@volcengine/sdk-core' {
  interface CommandOutputMap {
    ApplyObjectGroupsByAlertTemplateCommand: ApplyObjectGroupsByAlertTemplateCommandOutput;
    CreateAlertTemplateCommand: CreateAlertTemplateCommandOutput;
    CreateContactGroupCommand: CreateContactGroupCommandOutput;
    CreateContactsCommand: CreateContactsCommandOutput;
    CreateEventRuleCommand: CreateEventRuleCommandOutput;
    CreateNotificationCommand: CreateNotificationCommandOutput;
    CreateNotifyTemplateCommand: CreateNotifyTemplateCommandOutput;
    CreateO11yAgentECSDeployTaskCommand: CreateO11yAgentECSDeployTaskCommandOutput;
    CreateObjectGroupCommand: CreateObjectGroupCommandOutput;
    CreateRuleCommand: CreateRuleCommandOutput;
    CreateSilencePolicyCommand: CreateSilencePolicyCommandOutput;
    CreateWebhookCommand: CreateWebhookCommandOutput;
    DeleteAlertTemplatesByIdsCommand: DeleteAlertTemplatesByIdsCommandOutput;
    DeleteContactGroupByIdsCommand: DeleteContactGroupByIdsCommandOutput;
    DeleteContactsByIdsCommand: DeleteContactsByIdsCommandOutput;
    DeleteEventRuleCommand: DeleteEventRuleCommandOutput;
    DeleteNotificationsByIdsCommand: DeleteNotificationsByIdsCommandOutput;
    DeleteNotifyTemplatesByIdsCommand: DeleteNotifyTemplatesByIdsCommandOutput;
    DeleteObjectGroupCommand: DeleteObjectGroupCommandOutput;
    DeleteRulesByIdsCommand: DeleteRulesByIdsCommandOutput;
    DeleteSilencePolicyByIdsCommand: DeleteSilencePolicyByIdsCommandOutput;
    DeleteWebhooksByIdsCommand: DeleteWebhooksByIdsCommandOutput;
    DisableEventRuleCommand: DisableEventRuleCommandOutput;
    DisablePresetAlertTemplateCommand: DisablePresetAlertTemplateCommandOutput;
    EnableEventRuleCommand: EnableEventRuleCommandOutput;
    EnablePresetAlertTemplateCommand: EnablePresetAlertTemplateCommandOutput;
    GetMetricDataCommand: GetMetricDataCommandOutput;
    GetO11yAgentECSAutoInstallCommand: GetO11yAgentECSAutoInstallCommandOutput;
    GetTopDataCommand: GetTopDataCommandOutput;
    ListAlertGroupCommand: ListAlertGroupCommandOutput;
    ListAlertTemplatesCommand: ListAlertTemplatesCommandOutput;
    ListContactGroupByIdsCommand: ListContactGroupByIdsCommandOutput;
    ListContactGroupsCommand: ListContactGroupsCommandOutput;
    ListContactsCommand: ListContactsCommandOutput;
    ListContactsByIdsCommand: ListContactsByIdsCommandOutput;
    ListDefaultNotifyTemplatesCommand: ListDefaultNotifyTemplatesCommandOutput;
    ListEventRulesCommand: ListEventRulesCommandOutput;
    ListEventsCommand: ListEventsCommandOutput;
    ListNotificationsCommand: ListNotificationsCommandOutput;
    ListNotifyTemplatesCommand: ListNotifyTemplatesCommandOutput;
    ListO11yAgentECSInstanceMetadataCommand: ListO11yAgentECSInstanceMetadataCommandOutput;
    ListO11yAgentECSInstancesCommand: ListO11yAgentECSInstancesCommandOutput;
    ListO11yAgentECSProcessConfigsCommand: ListO11yAgentECSProcessConfigsCommandOutput;
    ListO11yAgentVpcEndpointsCommand: ListO11yAgentVpcEndpointsCommandOutput;
    ListObjectGroupsCommand: ListObjectGroupsCommandOutput;
    ListPresetAlertTemplatesCommand: ListPresetAlertTemplatesCommandOutput;
    ListRulesCommand: ListRulesCommandOutput;
    ListRulesByIdsCommand: ListRulesByIdsCommandOutput;
    ListSendAlertCommand: ListSendAlertCommandOutput;
    ListSilencePolicyCommand: ListSilencePolicyCommandOutput;
    ListWebhooksCommand: ListWebhooksCommandOutput;
    ListWebhooksByIdsCommand: ListWebhooksByIdsCommandOutput;
    ModifyStateOfSilencePolicyByIdsCommand: ModifyStateOfSilencePolicyByIdsCommandOutput;
    PerformO11yAgentECSDeployTaskCommand: PerformO11yAgentECSDeployTaskCommandOutput;
    SetStateOfRulesByIdsCommand: SetStateOfRulesByIdsCommandOutput;
    TagResourcesCommand: TagResourcesCommandOutput;
    UntagResourcesCommand: UntagResourcesCommandOutput;
    UpdateAlertTemplateCommand: UpdateAlertTemplateCommandOutput;
    UpdateContactGroupCommand: UpdateContactGroupCommandOutput;
    UpdateContactGroupWithContactsCommand: UpdateContactGroupWithContactsCommandOutput;
    UpdateContactsCommand: UpdateContactsCommandOutput;
    UpdateContactsWithContactGroupsCommand: UpdateContactsWithContactGroupsCommandOutput;
    UpdateEventRuleCommand: UpdateEventRuleCommandOutput;
    UpdateNotificationCommand: UpdateNotificationCommandOutput;
    UpdateNotifyTemplateCommand: UpdateNotifyTemplateCommandOutput;
    UpdateO11yAgentECSAutoInstallCommand: UpdateO11yAgentECSAutoInstallCommandOutput;
    UpdateO11yAgentECSProcessConfigCommand: UpdateO11yAgentECSProcessConfigCommandOutput;
    UpdateObjectGroupCommand: UpdateObjectGroupCommandOutput;
    UpdateRuleCommand: UpdateRuleCommandOutput;
    UpdateSilencePolicyCommand: UpdateSilencePolicyCommandOutput;
    UpdateWebhookCommand: UpdateWebhookCommandOutput;
  }
}
 ...
 */
export class CLOUDMONITORClient extends Client {
 ...
 */
export class CreateO11yAgentECSDeployTaskCommand extends Command<
  CreateO11yAgentECSDeployTaskRequest,
  CreateO11yAgentECSDeployTaskCommandOutput,
...
> {
  ...
  constructor(input: CreateO11yAgentECSDeployTaskRequest) {
    super(input);
    this.requestConfig = buildRequestConfigFromMetaPath(CreateO11yAgentECSDeployTaskCommand.metaPath);
  }
}
/**
 ...
 */
export class GetO11yAgentECSAutoInstallCommand extends Command<
  GetO11yAgentECSAutoInstallRequest,
  GetO11yAgentECSAutoInstallCommandOutput,
...
> {
  ...
  constructor(input: GetO11yAgentECSAutoInstallRequest) {
    super(input);
    this.requestConfig = buildRequestConfigFromMetaPath(GetO11yAgentECSAutoInstallCommand.metaPath);
  }
}
/**
 ...
 */
export class ListO11yAgentECSInstanceMetadataCommand extends Command<
  ListO11yAgentECSInstanceMetadataRequest,
  ListO11yAgentECSInstanceMetadataCommandOutput,
...
> {
  ...
  constructor(input: ListO11yAgentECSInstanceMetadataRequest) {
    super(input);
    this.requestConfig = buildRequestConfigFromMetaPath(ListO11yAgentECSInstanceMetadataCommand.metaPath);
  }
}
/**
 * Command to ListO11yAgentECSInstances
 */
export class ListO11yAgentECSInstancesCommand extends Command<
  ListO11yAgentECSInstancesRequest,
  ListO11yAgentECSInstancesCommandOutput,
...
> {
  ...
  constructor(input: ListO11yAgentECSInstancesRequest) {
    super(input);
    this.requestConfig = buildRequestConfigFromMetaPath(ListO11yAgentECSInstancesCommand.metaPath);
  }
}
/**
 * Command to ListO11yAgentECSProcessConfigs
 */
export class ListO11yAgentECSProcessConfigsCommand extends Command<
  ListO11yAgentECSProcessConfigsRequest,
  ListO11yAgentECSProcessConfigsCommandOutput,
...
> {
  ...
  constructor(input: ListO11yAgentECSProcessConfigsRequest) {
    super(input);
    this.requestConfig = buildRequestConfigFromMetaPath(ListO11yAgentECSProcessConfigsCommand.metaPath);
  }
}
/**
 * Command to ListO11yAgentVpcEndpoints
 */
export class ListO11yAgentVpcEndpointsCommand extends Command<
  ListO11yAgentVpcEndpointsRequest,
  ListO11yAgentVpcEndpointsCommandOutput,
...
> {
  ...
  constructor(input: ListO11yAgentVpcEndpointsRequest) {
    super(input);
    this.requestConfig = buildRequestConfigFromMetaPath(ListO11yAgentVpcEndpointsCommand.metaPath);
  }
}
/**
...
export class PerformO11yAgentECSDeployTaskCommand extends Command<
  ...
  PerformO11yAgentECSDeployTaskCommandOutput,
...
> {
  ...
  constructor(input: PerformO11yAgentECSDeployTaskRequest) {
    super(input);
    this.requestConfig = buildRequestConfigFromMetaPath(PerformO11yAgentECSDeployTaskCommand.metaPath);
  }
}
/**
 ...
 */
export class UpdateO11yAgentECSAutoInstallCommand extends Command<
  UpdateO11yAgentECSAutoInstallRequest,
  UpdateO11yAgentECSAutoInstallCommandOutput,
...
> {
  ...
  constructor(input: UpdateO11yAgentECSAutoInstallRequest) {
    super(input);
    this.requestConfig = buildRequestConfigFromMetaPath(UpdateO11yAgentECSAutoInstallCommand.metaPath);
  }
}
/**
 * Command to UpdateO11yAgentECSProcessConfig
 */
export class UpdateO11yAgentECSProcessConfigCommand extends Command<
  UpdateO11yAgentECSProcessConfigRequest,
  UpdateO11yAgentECSProcessConfigCommandOutput,
...
> {
  ...
  constructor(input: UpdateO11yAgentECSProcessConfigRequest) {
    super(input);
    this.requestConfig = buildRequestConfigFromMetaPath(UpdateO11yAgentECSProcessConfigCommand.metaPath);
  }
}
/**
