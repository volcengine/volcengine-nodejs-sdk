...
declare module '@volcengine/sdk-core' {
  interface CommandOutputMap {
    AddInlinePolicyToPermissionSetCommand: AddInlinePolicyToPermissionSetCommandOutput;
    AddSystemPolicyToPermissionSetCommand: AddSystemPolicyToPermissionSetCommandOutput;
    AddUserToGroupCommand: AddUserToGroupCommandOutput;
    AttachPolicyToUserProvisionCommand: AttachPolicyToUserProvisionCommandOutput;
    CreateAccountAssignmentCommand: CreateAccountAssignmentCommandOutput;
    CreateExternalSAMLIdentityProviderCommand: CreateExternalSAMLIdentityProviderCommandOutput;
    CreateGroupCommand: CreateGroupCommandOutput;
    CreatePermissionSetCommand: CreatePermissionSetCommandOutput;
    CreateSCIMServerCredentialCommand: CreateSCIMServerCredentialCommandOutput;
    CreateUserCommand: CreateUserCommandOutput;
    CreateUserProvisioningCommand: CreateUserProvisioningCommandOutput;
    DeleteAccountAssignmentCommand: DeleteAccountAssignmentCommandOutput;
    DeleteGroupCommand: DeleteGroupCommandOutput;
    DeletePermissionSetCommand: DeletePermissionSetCommandOutput;
    DeleteSCIMServerCredentialCommand: DeleteSCIMServerCredentialCommandOutput;
    DeleteUserCommand: DeleteUserCommandOutput;
    DeleteUserProvisioningCommand: DeleteUserProvisioningCommandOutput;
    DeleteUserProvisioningEventCommand: DeleteUserProvisioningEventCommandOutput;
    DeprovisionPermissionSetCommand: DeprovisionPermissionSetCommandOutput;
    DetachPolicyToUserProvisionCommand: DetachPolicyToUserProvisionCommandOutput;
    DisablePortalLoginSettingCommand: DisablePortalLoginSettingCommandOutput;
    DisableServiceCommand: DisableServiceCommandOutput;
    EnablePortalLoginSettingCommand: EnablePortalLoginSettingCommandOutput;
    EnableServiceCommand: EnableServiceCommandOutput;
    GetExternalSAMLIdentityProviderCommand: GetExternalSAMLIdentityProviderCommandOutput;
    GetGroupCommand: GetGroupCommandOutput;
    GetMFASettingsCommand: GetMFASettingsCommandOutput;
    GetPermissionSetCommand: GetPermissionSetCommandOutput;
    GetPortalLoginConfigCommand: GetPortalLoginConfigCommandOutput;
    GetSAMLServiceProviderCommand: GetSAMLServiceProviderCommandOutput;
    GetServiceStatusCommand: GetServiceStatusCommandOutput;
    GetTaskStatusCommand: GetTaskStatusCommandOutput;
    GetUserCommand: GetUserCommandOutput;
    GetUserProvisioningCommand: GetUserProvisioningCommandOutput;
    ListAccountAssignmentsCommand: ListAccountAssignmentsCommandOutput;
    ListGroupMembersCommand: ListGroupMembersCommandOutput;
    ListGroupsCommand: ListGroupsCommandOutput;
    ListPermissionPoliciesInPermissionSetCommand: ListPermissionPoliciesInPermissionSetCommandOutput;
    ListPermissionSetProvisioningsCommand: ListPermissionSetProvisioningsCommandOutput;
    ListPermissionSetsCommand: ListPermissionSetsCommandOutput;
    ListPortalLoginSettingsCommand: ListPortalLoginSettingsCommandOutput;
    ListSCIMServerCredentialsCommand: ListSCIMServerCredentialsCommandOutput;
    ListTasksCommand: ListTasksCommandOutput;
    ListUserProvisioningEventsCommand: ListUserProvisioningEventsCommandOutput;
    ListUserProvisioningsCommand: ListUserProvisioningsCommandOutput;
    ListUsersCommand: ListUsersCommandOutput;
    ProvisionPermissionSetCommand: ProvisionPermissionSetCommandOutput;
    RemovePermissionPolicyFromPermissionSetCommand: RemovePermissionPolicyFromPermissionSetCommandOutput;
    RemoveUserFromGroupCommand: RemoveUserFromGroupCommandOutput;
    ResetPasswordCommand: ResetPasswordCommandOutput;
    RetryUserProvisioningEventCommand: RetryUserProvisioningEventCommandOutput;
    UpdateGroupCommand: UpdateGroupCommandOutput;
    UpdateInlinePolicyToPermissionSetCommand: UpdateInlinePolicyToPermissionSetCommandOutput;
    UpdateInstanceNameCommand: UpdateInstanceNameCommandOutput;
    UpdateMFASettingsCommand: UpdateMFASettingsCommandOutput;
    UpdatePermissionSetCommand: UpdatePermissionSetCommandOutput;
    UpdateSAMLServiceProviderCommand: UpdateSAMLServiceProviderCommandOutput;
