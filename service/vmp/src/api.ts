...
declare module '@volcengine/sdk-core' {
  interface CommandOutputMap {
    CreateAggregateWorkspaceCommand: CreateAggregateWorkspaceCommandOutput;
    CreateAlertingRuleCommand: CreateAlertingRuleCommandOutput;
    CreateContactCommand: CreateContactCommandOutput;
    CreateContactGroupCommand: CreateContactGroupCommandOutput;
    CreateExternalPrometheusCommand: CreateExternalPrometheusCommandOutput;
    CreateIntegrationTaskCommand: CreateIntegrationTaskCommandOutput;
    CreateNotifyGroupPolicyCommand: CreateNotifyGroupPolicyCommandOutput;
    CreateNotifyPolicyCommand: CreateNotifyPolicyCommandOutput;
    CreateNotifyTemplateCommand: CreateNotifyTemplateCommandOutput;
    CreateRuleFileCommand: CreateRuleFileCommandOutput;
    CreateSilencePolicyCommand: CreateSilencePolicyCommandOutput;
    CreateWorkspaceCommand: CreateWorkspaceCommandOutput;
    DeleteAggregateWorkspaceCommand: DeleteAggregateWorkspaceCommandOutput;
    DeleteAlertingRulesCommand: DeleteAlertingRulesCommandOutput;
    DeleteContactGroupsCommand: DeleteContactGroupsCommandOutput;
    DeleteContactsCommand: DeleteContactsCommandOutput;
    DeleteExternalPrometheusCommand: DeleteExternalPrometheusCommandOutput;
    DeleteIntegrationTaskCommand: DeleteIntegrationTaskCommandOutput;
    DeleteNotifyGroupPolicyCommand: DeleteNotifyGroupPolicyCommandOutput;
    DeleteNotifyPolicyCommand: DeleteNotifyPolicyCommandOutput;
    DeleteNotifyTemplateCommand: DeleteNotifyTemplateCommandOutput;
    DeleteRuleFileCommand: DeleteRuleFileCommandOutput;
    DeleteSilencePoliciesCommand: DeleteSilencePoliciesCommandOutput;
    DeleteWorkspaceCommand: DeleteWorkspaceCommandOutput;
    DisableAlertingRulesCommand: DisableAlertingRulesCommandOutput;
    DisableIntegrationTasksCommand: DisableIntegrationTasksCommandOutput;
    DisableSilencePoliciesCommand: DisableSilencePoliciesCommandOutput;
    EnableAlertingRulesCommand: EnableAlertingRulesCommandOutput;
    EnableIntegrationTasksCommand: EnableIntegrationTasksCommandOutput;
    EnableSilencePoliciesCommand: EnableSilencePoliciesCommandOutput;
    GetAggregateWorkspaceCommand: GetAggregateWorkspaceCommandOutput;
    GetAlertCommand: GetAlertCommandOutput;
    GetAlertingRuleCommand: GetAlertingRuleCommandOutput;
    GetContactCommand: GetContactCommandOutput;
    GetContactGroupCommand: GetContactGroupCommandOutput;
    GetExternalPrometheusCommand: GetExternalPrometheusCommandOutput;
    GetIntegrationTaskCommand: GetIntegrationTaskCommandOutput;
    GetNotifyGroupPolicyCommand: GetNotifyGroupPolicyCommandOutput;
    GetNotifyPolicyCommand: GetNotifyPolicyCommandOutput;
    GetRuleFileCommand: GetRuleFileCommandOutput;
    GetWorkspaceCommand: GetWorkspaceCommandOutput;
    GetWorkspaceAuthInfoCommand: GetWorkspaceAuthInfoCommandOutput;
    ListAlertSamplesCommand: ListAlertSamplesCommandOutput;
    ListAlertingRulesCommand: ListAlertingRulesCommandOutput;
    ListAlertsCommand: ListAlertsCommandOutput;
    ListContactGroupsCommand: ListContactGroupsCommandOutput;
    ListContactsCommand: ListContactsCommandOutput;
    ListIntegrationTasksCommand: ListIntegrationTasksCommandOutput;
    ListNotifyGroupPoliciesCommand: ListNotifyGroupPoliciesCommandOutput;
    ListNotifyPoliciesCommand: ListNotifyPoliciesCommandOutput;
    ListNotifyTemplatesCommand: ListNotifyTemplatesCommandOutput;
    ListRuleFilesCommand: ListRuleFilesCommandOutput;
    ListRulesCommand: ListRulesCommandOutput;
    ListSilencePoliciesCommand: ListSilencePoliciesCommandOutput;
    ListTagsForResourcesCommand: ListTagsForResourcesCommandOutput;
    ListWorkspaceInstanceTypesCommand: ListWorkspaceInstanceTypesCommandOutput;
    ListWorkspaceStatusCommand: ListWorkspaceStatusCommandOutput;
    ListWorkspacesCommand: ListWorkspacesCommandOutput;
    SendValidationMessageCommand: SendValidationMessageCommandOutput;
    TagResourcesCommand: TagResourcesCommandOutput;
    TestDingTalkBotWebhookCommand: TestDingTalkBotWebhookCommandOutput;
    TestLarkBotWebhookCommand: TestLarkBotWebhookCommandOutput;
    TestWeComBotWebhookCommand: TestWeComBotWebhookCommandOutput;
    TestWebhookCommand: TestWebhookCommandOutput;
    UntagResourcesCommand: UntagResourcesCommandOutput;
    UpdateAggregateWorkspaceCommand: UpdateAggregateWorkspaceCommandOutput;
    UpdateAlertingRuleCommand: UpdateAlertingRuleCommandOutput;
    UpdateContactCommand: UpdateContactCommandOutput;
    UpdateContactGroupCommand: UpdateContactGroupCommandOutput;
    UpdateExternalPrometheusCommand: UpdateExternalPrometheusCommandOutput;
    UpdateIntegrationTaskCommand: UpdateIntegrationTaskCommandOutput;
    UpdateNotifyGroupPolicyCommand: UpdateNotifyGroupPolicyCommandOutput;
    UpdateNotifyPolicyCommand: UpdateNotifyPolicyCommandOutput;
    UpdateNotifyTemplateCommand: UpdateNotifyTemplateCommandOutput;
    UpdateRuleFileCommand: UpdateRuleFileCommandOutput;
