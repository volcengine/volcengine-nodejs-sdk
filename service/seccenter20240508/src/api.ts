...
declare module '@volcengine/sdk-core' {
  interface CommandOutputMap {
    AddBaselineCheckConfigCommand: AddBaselineCheckConfigCommandOutput;
    AddMonitorPolicyCommand: AddMonitorPolicyCommandOutput;
    BanAlarmIPCommand: BanAlarmIPCommandOutput;
    BatchDeleteVarmorPoliciesCommand: BatchDeleteVarmorPoliciesCommandOutput;
    BatchInstallVarmorAppsCommand: BatchInstallVarmorAppsCommandOutput;
    BatchUninstallVarmorAppsCommand: BatchUninstallVarmorAppsCommandOutput;
    BatchUpgradeVarmorAppsCommand: BatchUpgradeVarmorAppsCommandOutput;
    BindMLPAuthCommand: BindMLPAuthCommandOutput;
    CheckAlarmSupportBanIPCommand: CheckAlarmSupportBanIPCommandOutput;
    CheckMonitorPolicyCommand: CheckMonitorPolicyCommandOutput;
    ControlMonitorPolicyCommand: ControlMonitorPolicyCommandOutput;
    CreateMLPAssetSyncTaskCommand: CreateMLPAssetSyncTaskCommandOutput;
    CreateVarmorPolicyCommand: CreateVarmorPolicyCommandOutput;
    DeleteBaselineCheckConfigCommand: DeleteBaselineCheckConfigCommandOutput;
    DeleteMonitorPolicyCommand: DeleteMonitorPolicyCommandOutput;
    DescribeFileChangeTrendTop5Command: DescribeFileChangeTrendTop5CommandOutput;
    DescribeFileMonitorOverviewCommand: DescribeFileMonitorOverviewCommandOutput;
    DescribeLastWeekFileChangeTrendsCommand: DescribeLastWeekFileChangeTrendsCommandOutput;
    DetectBaselineByCheckConfigCommand: DetectBaselineByCheckConfigCommandOutput;
    EditBaselineCheckConfigCommand: EditBaselineCheckConfigCommandOutput;
    EditFingerprintCollectConfigCommand: EditFingerprintCollectConfigCommandOutput;
    EditMonitorPolicyCommand: EditMonitorPolicyCommandOutput;
    ExportFileMonitorAlarmListDataCommand: ExportFileMonitorAlarmListDataCommandOutput;
    GetAIAlarmJudgeConfigCommand: GetAIAlarmJudgeConfigCommandOutput;
    GetAlarmRuleListCommand: GetAlarmRuleListCommandOutput;
    GetAlarmTraceRawDataCommand: GetAlarmTraceRawDataCommandOutput;
    GetAllMonitorSuffixListCommand: GetAllMonitorSuffixListCommandOutput;
    GetArmorProfileCommand: GetArmorProfileCommandOutput;
    GetAutoIsolateAgentListCommand: GetAutoIsolateAgentListCommandOutput;
    GetAutoProtectConfigCommand: GetAutoProtectConfigCommandOutput;
    GetBruteForceBanCapParamsCommand: GetBruteForceBanCapParamsCommandOutput;
    GetBruteForceBanConfigCommand: GetBruteForceBanConfigCommandOutput;
    GetBruteForceBanStatisticsCommand: GetBruteForceBanStatisticsCommandOutput;
    GetClusterStatisticsCommand: GetClusterStatisticsCommandOutput;
    GetCustomWeakPasswordsCommand: GetCustomWeakPasswordsCommandOutput;
    GetFingerprintEnvCommand: GetFingerprintEnvCommandOutput;
    GetGeoLocationCommand: GetGeoLocationCommandOutput;
    GetHostVolumeCommand: GetHostVolumeCommandOutput;
    GetMLPAssetSyncTaskDetailCommand: GetMLPAssetSyncTaskDetailCommandOutput;
    GetMLPAssetSyncTaskStatusCommand: GetMLPAssetSyncTaskStatusCommandOutput;
    GetMonitorPolicyDirectoryCommand: GetMonitorPolicyDirectoryCommandOutput;
    GetMultiLevelAuthDetailCommand: GetMultiLevelAuthDetailCommandOutput;
    GetOfflineNotificationConfigCommand: GetOfflineNotificationConfigCommandOutput;
    GetOfflineNotificationListCommand: GetOfflineNotificationListCommandOutput;
    GetPolicyStatisticsCommand: GetPolicyStatisticsCommandOutput;
    GetSOCAssetAlarmStatsCommand: GetSOCAssetAlarmStatsCommandOutput;
    GetSOCAssetInstanceProtectStatusCommand: GetSOCAssetInstanceProtectStatusCommandOutput;
    GetSOCAssetSecurityScoreCommand: GetSOCAssetSecurityScoreCommandOutput;
    GetSOCAssetVulnStatsCommand: GetSOCAssetVulnStatsCommandOutput;
    GetSOCPrecautionBaselineStatsCommand: GetSOCPrecautionBaselineStatsCommandOutput;
    GetSecurityOverviewScoreStatsCommand: GetSecurityOverviewScoreStatsCommandOutput;
    GetVarmorConfigYAMLCommand: GetVarmorConfigYAMLCommandOutput;
    GetVarmorPolicyCommand: GetVarmorPolicyCommandOutput;
    GetVarmorTLSInfoCommand: GetVarmorTLSInfoCommandOutput;
    HandleEndpointAlarmsCommand: HandleEndpointAlarmsCommandOutput;
    ListAgentProxiesCommand: ListAgentProxiesCommandOutput;
    ListAgentProxyServersCommand: ListAgentProxyServersCommandOutput;
    ListAssetCenterHostsCommand: ListAssetCenterHostsCommandOutput;
    ListAssetNamespacesCommand: ListAssetNamespacesCommandOutput;
    ListAutoDefenseRulesCommand: ListAutoDefenseRulesCommandOutput;
    ListBanIPListCommand: ListBanIPListCommandOutput;
    ListBaselineBasicInfoCommand: ListBaselineBasicInfoCommandOutput;
    ListBaselineCheckConfigCommand: ListBaselineCheckConfigCommandOutput;
    ListBaselineCheckItemsCommand: ListBaselineCheckItemsCommandOutput;
    ListBaselineForGroupPolicyCommand: ListBaselineForGroupPolicyCommandOutput;
    ListBaselineHostItemHostsCommand: ListBaselineHostItemHostsCommandOutput;
    ListBatchEndpointHandleMethodsCommand: ListBatchEndpointHandleMethodsCommandOutput;
    ListCheckConfigRelatedBaselineCommand: ListCheckConfigRelatedBaselineCommandOutput;
    ListCleanHistoryCommand: ListCleanHistoryCommandOutput;
    ListCloudEnvsCommand: ListCloudEnvsCommandOutput;
    ListClusterVarmorVersionHistoryCommand: ListClusterVarmorVersionHistoryCommandOutput;
    ListClustersAndVarmorAppsCommand: ListClustersAndVarmorAppsCommandOutput;
    ListFileMonitorAlarmsCommand: ListFileMonitorAlarmsCommandOutput;
    ListFingerprintCollectConfigCommand: ListFingerprintCollectConfigCommandOutput;
    ListHidsAlarmsCommand: ListHidsAlarmsCommandOutput;
    ListHostsBasicInfosCommand: ListHostsBasicInfosCommandOutput;
    ListIsolationFilesCommand: ListIsolationFilesCommandOutput;
    ListMLPAssetTasksCommand: ListMLPAssetTasksCommandOutput;
    ListMonitorPoliciesCommand: ListMonitorPoliciesCommandOutput;
    ListOrderedHostsBasicInfosCommand: ListOrderedHostsBasicInfosCommandOutput;
    ListScanSubTasksCommand: ListScanSubTasksCommandOutput;
    ListVarmorPoliciesCommand: ListVarmorPoliciesCommandOutput;
    ListVulByPodCommand: ListVulByPodCommandOutput;
    ListVulDetailCommand: ListVulDetailCommandOutput;
    ListVulHostByPodCommand: ListVulHostByPodCommandOutput;
    RefreshVarmorInfoCommand: RefreshVarmorInfoCommandOutput;
    RetryIPOperationCommand: RetryIPOperationCommandOutput;
    SetAIAlarmJudgeConfigCommand: SetAIAlarmJudgeConfigCommandOutput;
    SetBruteForceBanConfigCommand: SetBruteForceBanConfigCommandOutput;
    SetCustomWeakPasswordsCommand: SetCustomWeakPasswordsCommandOutput;
    StopMLPAssetSyncTaskCommand: StopMLPAssetSyncTaskCommandOutput;
    UnBanIPItemCommand: UnBanIPItemCommandOutput;
    UnbindMLPAuthCommand: UnbindMLPAuthCommandOutput;
    UpdateAutoProtectConfigCommand: UpdateAutoProtectConfigCommandOutput;
    UpdateBaselineCheckConfigSwitchCommand: UpdateBaselineCheckConfigSwitchCommandOutput;
    UpdateCloudProviderCommand: UpdateCloudProviderCommandOutput;
    UpdateOfflineNotificationConfigCommand: UpdateOfflineNotificationConfigCommandOutput;
    UpdateVarmorAppConfigCommand: UpdateVarmorAppConfigCommandOutput;
    UpdateVarmorPolicyCommand: UpdateVarmorPolicyCommandOutput;
    UpdateVarmorTLSInfoCommand: UpdateVarmorTLSInfoCommandOutput;
  }
}
