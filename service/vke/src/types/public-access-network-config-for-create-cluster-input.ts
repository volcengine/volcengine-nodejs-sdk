 ...
 *
 * @export
 * @interface PublicAccessNetworkConfigForCreateClusterInput
 */
export interface PublicAccessNetworkConfigForCreateClusterInput {
     ...
     * @memberof PublicAccessNetworkConfigForCreateClusterInput
     */
    Isp?: PublicAccessNetworkConfigForCreateClusterInputIspEnum;
}
 ...
 * @enum {string}
 */
export enum PublicAccessNetworkConfigForCreateClusterInputIspEnum {
    BGP = 'BGP',
