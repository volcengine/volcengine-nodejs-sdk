...
declare module '@volcengine/sdk-core' {
  interface CommandOutputMap {
    ...
    DeleteGroupAsyncCommand: DeleteGroupAsyncCommandOutput;
    DeleteGroupsCommand: DeleteGroupsCommandOutput;
    DeleteInstanceCommand: DeleteInstanceCommandOutput;
    DeletePrivateLinkCommand: DeletePrivateLinkCommandOutput;
    DeletePublicAddressCommand: DeletePublicAddressCommandOutput;
    DeleteTopicCommand: DeleteTopicCommandOutput;
    DeleteTopicAsyncCommand: DeleteTopicAsyncCommandOutput;
    DescribeAccessKeyDetailCommand: DescribeAccessKeyDetailCommandOutput;
    DescribeAccessKeysCommand: DescribeAccessKeysCommandOutput;
    ...
    DescribeConsumedClientsCommand: DescribeConsumedClientsCommandOutput;
    DescribeConsumedTopicDetailCommand: DescribeConsumedTopicDetailCommandOutput;
    DescribeConsumedTopicsCommand: DescribeConsumedTopicsCommandOutput;
    DescribeGroupsCommand: DescribeGroupsCommandOutput;
    DescribeGroupsDetailCommand: DescribeGroupsDetailCommandOutput;
    DescribeInstanceDetailCommand: DescribeInstanceDetailCommandOutput;
    DescribeInstancesCommand: DescribeInstancesCommandOutput;
    DescribePLWhitelistCommand: DescribePLWhitelistCommandOutput;
    DescribeRegionsCommand: DescribeRegionsCommandOutput;
    DescribeSecretKeyCommand: DescribeSecretKeyCommandOutput;
    ...
    DescribeTopicDetailCommand: DescribeTopicDetailCommandOutput;
    DescribeTopicGroupsCommand: DescribeTopicGroupsCommandOutput;
    DescribeTopicQueueCommand: DescribeTopicQueueCommandOutput;
    DescribeTopicsCommand: DescribeTopicsCommandOutput;
    DisassociateAllowListCommand: DisassociateAllowListCommandOutput;
    EnableAutoCreateGroupCommand: EnableAutoCreateGroupCommandOutput;
    EnableInstanceBurstTpsCommand: EnableInstanceBurstTpsCommandOutput;
    EnableInstanceInspectCommand: EnableInstanceInspectCommandOutput;
    GetInspectConfigCommand: GetInspectConfigCommandOutput;
    GetInstanceInspectResultCommand: GetInstanceInspectResultCommandOutput;
    ManualProcessResultCommand: ManualProcessResultCommandOutput;
    ManualTriggerInspectCommand: ManualTriggerInspectCommandOutput;
    MessageSendCommand: MessageSendCommandOutput;
    ModifyAccessKeyAllAuthorityCommand: ModifyAccessKeyAllAuthorityCommandOutput;
    ModifyAccessKeyAuthorityCommand: ModifyAccessKeyAuthorityCommandOutput;
    ModifyAllowListCommand: ModifyAllowListCommandOutput;
    ModifyGroupDescriptionCommand: ModifyGroupDescriptionCommandOutput;
    ...
    ModifyTopicAccessPoliciesCommand: ModifyTopicAccessPoliciesCommandOutput;
    ModifyTopicDescriptionCommand: ModifyTopicDescriptionCommandOutput;
    QueryDLQMessageByGroupIdCommand: QueryDLQMessageByGroupIdCommandOutput;
    QueryDLQMessageByIdCommand: QueryDLQMessageByIdCommandOutput;
    QueryMessageByMsgIdCommand: QueryMessageByMsgIdCommandOutput;
    QueryMessageByMsgKeyCommand: QueryMessageByMsgKeyCommandOutput;
    QueryMessageByOffsetCommand: QueryMessageByOffsetCommandOutput;
    QueryMessageByTimestampCommand: QueryMessageByTimestampCommandOutput;
    QueryMessageTraceByMessageIdCommand: QueryMessageTraceByMessageIdCommandOutput;
    RemovePLWhitelistCommand: RemovePLWhitelistCommandOutput;
    RemoveTagsFromResourceCommand: RemoveTagsFromResourceCommandOutput;
    ResendDLQMessageByIdCommand: ResendDLQMessageByIdCommandOutput;
